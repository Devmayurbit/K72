...
import AgencyHeroFixed from '../components/footer/AgencyHeroFixed'
import AgencyTextBlock from '../components/footer/AgencyTextBlock'
...
const Agence = () => {
  ...
  useGSAP(function () {
    ...
    gsap.to(imageDivRef.current, {
      scrollTrigger: {
        ...
        pin: true,
        pinSpacing: false, // <-- Changed to remove extra space
        pinReparent: true,
        pinType: 'transform',
  ...
  return (
    <div className='parent overflow-auto scrollbar-hide'>
      <div id='page1' className='py-1 '>
        ...
        <div className='relative font-[font2]'>
          <div className='lg:mt-[20vh] mt-[10vh]'> {/* <-- Reduced top margin */}
